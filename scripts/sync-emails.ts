...
const templatesToUpdate = [
  {
    ...
    body: `
      ...
      <p style="margin-top:24px; text-align:center;"><a href="${appUrl}/checkout?quoteId={{quoteDbId}}&piNumber={{quoteId}}" style="display:inline-block; background-color:#1e40af; color:white; padding:14px 30px; text-decoration:none; border-radius:6px; font-weight:bold; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">Proceed to Secure Checkout →</a></p>
    `,
